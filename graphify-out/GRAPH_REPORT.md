...
## Corpus Check
- 66 files · ~96,656 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 735 nodes · 744 edges · 76 communities (61 shown, 15 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `48be3f29`
...
2. `Статус проекта CreateOrder` - 18 edges
...
## Knowledge Gaps
- **438 isolated node(s):** `0. System Instructions (Agent Rules)`, `1. Глобальная цель`, `2. Текущее состояние (Active State)`, `3. Архитектурные решения (ADR)`, `3.1. AI Factory / Pipeline Notes` (+433 more)
