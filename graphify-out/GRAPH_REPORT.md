# Graph Report - CreateOrder  (2026-07-18)

## Corpus Check
- 68 files · ~104,345 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 751 nodes · 758 edges · 78 communities (63 shown, 15 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2a034e34`
...
- Test-PersonnelActionWizard-no-loc.ps1
...
2. `Статус проекта CreateOrder` - 20 edges
...
7. `Block 2. Enrollment workflow: new tab and rules engine` - 12 edges
8. `Технический план: Массовое добавление сотрудников на лист "Выплаты_Без_Периодов"` - 10 edges
9. `Спецификация: Массовое добавление сотрудников на лист "Выплаты_Без_Периодов"` - 10 edges
10. `������������: ������������� ������� ������ � ���������� ��� ��������` - 10 edges
...
Cohesion: 0.40
Nodes (4): D89 Validation, Goal, Scope, Стабильность расположения листов и тестов
...
Cohesion: 0.33
Nodes (5): В начале каждой сессии, Внедрение проверенных изменений, Документация — обязательная часть работы, Правила работы с проектом CreateOrder, Формат статуса

### Community 64 - "Спецификация: операторский интерфейс мастера зачисления"
Cohesion: 0.33
...
### Community 68 - "Матрица приёмки замечаний по мастеру зачисления"
Cohesion: 0.50
Nodes (3): Матрица приёмки замечаний по мастеру зачисления, Неподтверждённые величины, Обязательный финальный сценарий

### Community 70 - "Компактные формы перемещения и исключения"
Cohesion: 0.33
...
### Community 76 - "Нормативные разделы приказа о зачислении"
Cohesion: 0.33
Nodes (5): Нормативные разделы приказа о зачислении, Правила формирования, Проверка, Хранение, Цель

### Community 77 - "Компактная сетка ежемесячных выплат"
Cohesion: 0.33
Nodes (5): Компактная сетка ежемесячных выплат, Проверка, Результат, Решения, Цель

## Knowledge Gaps
- **448 isolated node(s):** `0. System Instructions (Agent Rules)`, `1. Глобальная цель`, `2. Текущее состояние (Active State)`, `3. Архитектурные решения (ADR)`, `3.1. AI Factory / Pipeline Notes` (+443 more)
