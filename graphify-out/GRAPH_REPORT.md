...
## Corpus Check
- 67 files · ~103,504 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 744 nodes · 752 edges · 77 communities (62 shown, 15 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1f3e6ec0`
...
2. `Статус проекта CreateOrder` - 19 edges
...
## Knowledge Gaps
- **443 isolated node(s):** `0. System Instructions (Agent Rules)`, `1. Глобальная цель`, `2. Текущее состояние (Active State)`, `3. Архитектурные решения (ADR)`, `3.1. AI Factory / Pipeline Notes` (+438 more)
