...
* **Версия:** 1.6.0 (Licensing Freemium & About UI)
* **Текущий статус:** Стабильно. Freemium: базовые функции доступны, экспорт под проверкой лицензии; обновлён UI окна активации.
