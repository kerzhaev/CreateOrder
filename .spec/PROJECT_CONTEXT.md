...
* **Версия:** 1.5.0 (Licensing Update)
* **Текущая задача:** Стабилизация после рефакторинга ядра, лицензирования и ленты.
* **Текущий статус:** Внедрены FIO Engine, оффлайн-лицензирование, редизайн ленты; валидация надбавок и экспорт рапортов обновлены.
