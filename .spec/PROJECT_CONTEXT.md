...
* `mdlZP12Validation.bas` — Проверка внешнего шаблона ZP12 по листу "Штат" с подсветкой ошибок и историей прогонов.
...
- **v.1.7.6 (12.03.2026):**
  - **Feature (mdlZP12Validation):** Добавлена отдельная проверка внешнего шаблона ZP12.
    ...
    - Добавлен лист `История_проверок_ZP12` с накопительной историей прогонов и статусами `NEW`, `OPEN`, `RESOLVED`.
  ...
  - **UX/UI (Ribbon):** На вкладку `СВО Макросы` добавлена кнопка `Проверить ZP12`.
