...
* **В работе:** Licensing v2 (Time-Bomb & Admin Panel); Self-Healing Architecture — автоматическое восстановление структуры книги. См. `.spec/tasks/self-healing/`.
...
- **v.1.7.0 (23.02.2026):**
<<<<<<< HEAD
  - **Feature (Self-Healing):** Успешно протестирована и внедрена система Self-Healing. Макрос автоматически воссоздает листы 'ДСО' и 'Надбавки без периодов' с правильным форматированием при событии Workbook_Open.
=======
  - **Architecture:** Внедрена система Self-Healing Architecture. Макрос автоматически проверяет целостность листов (ДСО, Надбавки) при событии Workbook_Open и алгоритмически воссоздает их структуру (шапки, фильтры, Freeze Panes) в случае удаления пользователем.
>>>>>>> feature/self-healing-structure
